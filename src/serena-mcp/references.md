...
- [REF-7] Introducing the Model Context Protocol — Anthropic (official announcement; verified 2026-07-22: "an open standard that enables developers to build secure, two-way connections between their data sources and AI-powered tools") — https://www.anthropic.com/news/model-context-protocol
